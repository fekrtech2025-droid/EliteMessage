...
export declare class AdminInstancesController {
    private readonly instancesService;
    constructor(instancesService: InstancesService);
    getInstanceDetail(instanceId: string): Promise<{
        instance: {
            id: string;
            publicId: string;
            workspaceId: string;
    ...
    getInstanceScreenshot(instanceId: string, response: Response): Promise<Response<any, Record<string, any>>>;
...
//# sourceMappingURL=admin-instances.controller.d.ts.map