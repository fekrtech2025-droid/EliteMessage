module.exports = [
  ...
  (a, b, c) => {
    ...
    let i = (d = a.r(53798)) && d.__esModule ? d : { default: d },
      j = a.r(94908),
      k = a.r(23161),
      l = a.r(32319),
      m = a.r(56704),
...
${b}`
        ...
        if (c)
          switch (c.type) {
            ...
            case 'generate-static-params':
              throw Object.defineProperty(
                Error(
                  `Route ${b.route} used \`cookies()\` inside \`generateStaticParams\`. This is not supported because \`generateStaticParams\` runs at build time without an HTTP request. Read more: https://nextjs.org/docs/messages/next-dynamic-api-wrong-context`,
                ),
                '__NEXT_ERROR_CODE',
                { value: 'E1123', enumerable: !1, configurable: !0 },
              );
            case 'prerender':
              var k = b,
                q = c;
            ...
            case 'validation-client':
              ...
              throw Object.defineProperty(
                new m.InvariantError(
                  `${t} must not be used within a Client Component. Next.js should be preventing ${t} from being included in Client Components statically, but did not in this case.`,
                ),
                '__NEXT_ERROR_CODE',
                { value: 'E1037', enumerable: !1, configurable: !0 },
              );
            case 'prerender-ppr':
            ...
            case 'prerender-runtime':
              return (0, j.delayUntilRuntimeStage)(c, p(c.cookies));
            case 'private-cache':
              return p(c.cookies);
            case 'request':
              let u;
              if (
                ...
                (u = (0, d.areCookiesMutableInCurrentPhase)(c)
                ...
                return p(u);
              {
                let a = (0, g.isInEarlyRenderStage)(c);
                if (u === c.mutableCookies)
                  return a
                    ? c.asyncApiPromises.earlyMutableCookies
                    : c.asyncApiPromises.mutableCookies;
                return a
                  ? c.asyncApiPromises.earlyCookies
                  : c.asyncApiPromises.cookies;
              }
          }
      }
      ...
      if (b) {
        ...
        if (c)
          switch (c.type) {
            ...
            case 'generate-static-params':
              throw Object.defineProperty(
                Error(
                  `Route ${b.route} used \`headers()\` inside \`generateStaticParams\`. This is not supported because \`generateStaticParams\` runs at build time without an HTTP request. Read more: https://nextjs.org/docs/messages/next-dynamic-api-wrong-context`,
                ),
                '__NEXT_ERROR_CODE',
                { value: 'E1134', enumerable: !1, configurable: !0 },
              );
          }
        if (b.dynamicShouldError)
          throw Object.defineProperty(
        ...
        if (c)
          switch (c.type) {
            ...
            case 'validation-client':
              ...
              throw Object.defineProperty(
                new l.InvariantError(
                  `${r} must not be used within a client component. Next.js should be preventing ${r} from being included in client components statically, but did not in this case.`,
                ),
                '__NEXT_ERROR_CODE',
                { value: 'E1017', enumerable: !1, configurable: !0 },
              );
            case 'prerender-ppr':
            ...
            case 'prerender-runtime':
              return (0, i.delayUntilRuntimeStage)(c, o(c.headers));
            case 'private-cache':
              return o(c.headers);
            case 'request':
              if (
                ((0, g.trackDynamicDataInDynamicRender)(c), c.asyncApiPromises)
              )
                return (0, f.isInEarlyRenderStage)(c)
                  ? c.asyncApiPromises.earlyHeaders
                  : c.asyncApiPromises.headers;
              return o(c.headers);
          }
      }
  ...
  (a, b, c) => {
    ...
    function l() {
      let a = 'draftMode',
        b = e.workAsyncStorage.getStore(),
        c = d.workUnitAsyncStorage.getStore();
      switch (((!b || !c) && (0, d.throwForMissingRequestStore)(a), c.type)) {
        case 'prerender-runtime':
          return (0, k.delayUntilRuntimeStage)(c, m(c.draftMode, b));
        case 'request':
          return m(c.draftMode, b);
        case 'cache':
        case 'private-cache':
        case 'unstable-cache':
          let f = (0, d.getDraftModeProviderForCacheScope)(b, c);
          if (f) return m(f, b);
        case 'prerender':
        case 'prerender-ppr':
        case 'prerender-legacy':
        ...
        case 'validation-client': {
          ...
          throw Object.defineProperty(
            ...
            '__NEXT_ERROR_CODE',
            { value: 'E1046', enumerable: !1, configurable: !0 },
          );
        }
        case 'generate-static-params':
          throw Object.defineProperty(
            Error(
              `Route ${b.route} used \`${a}()\` inside \`generateStaticParams\`. This is not supported because \`generateStaticParams\` runs at build time without an HTTP request. Read more: https://nextjs.org/docs/messages/next-dynamic-api-wrong-context`,
            ),
            '__NEXT_ERROR_CODE',
            { value: 'E1132', enumerable: !1, configurable: !0 },
          );
        default:
          return c;
      }
    ...
    function m(a, b) {
      let c = o.get(a ?? n);
      return c || Promise.resolve(new p(a));
    }
    a.r(83276);
    let n = {},
      o = new WeakMap();
    class p {
      ...
      enable() {
        (q('draftMode().enable()', this.enable),
          null !== this._provider && this._provider.enable());
      }
      disable() {
        (q('draftMode().disable()', this.disable),
        ...
        if (g)
          switch (g.type) {
            ...
            case 'generate-static-params':
              throw Object.defineProperty(
                Error(
                  `Route ${c.route} used \`${a}\` inside \`generateStaticParams\`. This is not supported because \`generateStaticParams\` runs at build time without an HTTP request. Read more: https://nextjs.org/docs/messages/next-dynamic-api-wrong-context`,
                ),
                '__NEXT_ERROR_CODE',
                { value: 'E1121', enumerable: !1, configurable: !0 },
              );
          }
      }
    }
  ...
  7728,
  (a, b, c) => {
    ((b.exports.cookies = a.r(23072).cookies),
      (b.exports.headers = a.r(57514).headers),
      (b.exports.draftMode = a.r(83481).draftMode));
  },
  31941,
  (a) => {
    'use strict';
    ...
    let c = (0, b.registerClientReference)(
        function () {
          throw Error(
            "Attempted to call AuthHelpDialog() from the server but AuthHelpDialog is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
          );
        },
        '[project]/packages/ui/src/components/auth-primitives.tsx <module evaluation>',
        'AuthHelpDialog',
      ),
      d = (0, b.registerClientReference)(
        function () {
          throw Error(
            "Attempted to call AuthSegmentedControl() from the server but AuthSegmentedControl is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
          );
        },
        '[project]/packages/ui/src/components/auth-primitives.tsx <module evaluation>',
        'AuthSegmentedControl',
      ...
      e = (0, b.registerClientReference)(
        function () {
          throw Error(
            "Attempted to call AuthSplitLayout() from the server but AuthSplitLayout is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
          );
        },
        '[project]/packages/ui/src/components/auth-primitives.tsx <module evaluation>',
        'AuthSplitLayout',
      ...
      f = (0, b.registerClientReference)(
        function () {
          throw Error(
            "Attempted to call HelpIconButton() from the server but HelpIconButton is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
          );
        },
        '[project]/packages/ui/src/components/auth-primitives.tsx <module evaluation>',
        'HelpIconButton',
      ...
      h = (0, b.registerClientReference)(
        function () {
          throw Error(
            "Attempted to call PasswordStrengthMeter() from the server but PasswordStrengthMeter is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
          );
        },
        '[project]/packages/ui/src/components/auth-primitives.tsx <module evaluation>',
        'PasswordStrengthMeter',
  ...
  (a) => {
    ...
    let c = (0, b.registerClientReference)(
        ...
        '[project]/packages/ui/src/components/auth-primitives.tsx',
        'AuthHelpDialog',
      ),
      d = (0, b.registerClientReference)(
        function () {
  ...
  (a) => {
    'use strict';
    a.s(['QrPayloadView', () => b]);
    let b = (0, a.i(38793).registerClientReference)(
      function () {
        throw Error(
          "Attempted to call QrPayloadView() from the server but QrPayloadView is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
        );
      },
      '[project]/packages/ui/src/components/qr-payload-view.tsx <module evaluation>',
      'QrPayloadView',
    );
  },
  7974,
  (a) => {
    ...
    let b = (0, a.i(38793).registerClientReference)(
      ...
      '[project]/packages/ui/src/components/qr-payload-view.tsx',
      'QrPayloadView',
    );
  },
  40032,
  ...
  (a) => {
    ...
    let c = (0, b.registerClientReference)(
        function () {
          throw Error(
            "Attempted to call ThemePreferenceMenuButton() from the server but ThemePreferenceMenuButton is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
          );
        },
        '[project]/packages/ui/src/components/theme-preference.tsx <module evaluation>',
        'ThemePreferenceMenuButton',
      ),
      d = (0, b.registerClientReference)(
        function () {
          throw Error(
            "Attempted to call ThemePreferenceProvider() from the server but ThemePreferenceProvider is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
          );
        },
        '[project]/packages/ui/src/components/theme-preference.tsx <module evaluation>',
        'ThemePreferenceProvider',
      ...
      e = (0, b.registerClientReference)(
        function () {
          throw Error(
            "Attempted to call initializeThemePreference() from the server but initializeThemePreference is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
          );
        },
        '[project]/packages/ui/src/components/theme-preference.tsx <module evaluation>',
        'initializeThemePreference',
      ...
      f = (0, b.registerClientReference)(
        function () {
          throw Error(
            "Attempted to call setGlobalThemePreference() from the server but setGlobalThemePreference is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
          );
        },
        '[project]/packages/ui/src/components/theme-preference.tsx <module evaluation>',
        'setGlobalThemePreference',
      ...
      g = (0, b.registerClientReference)(
        function () {
          throw Error(
            "Attempted to call useThemePreference() from the server but useThemePreference is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
          );
        },
        '[project]/packages/ui/src/components/theme-preference.tsx <module evaluation>',
        'useThemePreference',
  ...
  (a) => {
    ...
    let c = (0, b.registerClientReference)(
        ...
        '[project]/packages/ui/src/components/theme-preference.tsx',
        'ThemePreferenceMenuButton',
      ),
      d = (0, b.registerClientReference)(
        function () {
  ...
  (a) => {
    ...
    var b = a.i(18588),
      c = a.i(7728);
    let d = { narrow: 760, normal: 1160, wide: 1360 };
    function e(a, b, c) {
      b
        ? a.setAttribute('data-nav-collapsed', 'true')
        : a.removeAttribute('data-nav-collapsed');
      let d = a.querySelector('.elite-shell-frame');
      d &&
        (b
          ? d.setAttribute('data-nav-collapsed', 'true')
          : d.removeAttribute('data-nav-collapsed'));
      let e = c
        ? a.querySelector(`#${c}`)
        : a.querySelector('.elite-shell-aside');
      e && ((e.hidden = !1), e.removeAttribute('aria-hidden'));
      let f = a.querySelector('.elite-shell-mobile-nav');
      f && (f.hidden = b);
      let g = a.querySelector('.elite-shell-topbar-brand-launcher');
      if (g) {
        let a = g.dataset.collapseLabel ?? 'Collapse sidebar menu',
          c = g.dataset.expandLabel ?? 'Expand sidebar menu';
        ((g.dataset.state = b ? 'collapsed' : 'expanded'),
          g.setAttribute('aria-expanded', b ? 'false' : 'true'),
          g.setAttribute('aria-label', b ? c : a));
      }
    }
    let f = `
...
`;
    ...
    a.s(
      [
        ...
        function ({
          ...
          contentWidth: q = 'wide',
          headerMode: r = 'default',
          topbarBrandMarkAlt: s,
          labels: t,
        }) {
          let u = l ? `elite-shell-nav-${o}` : void 0,
            v = 'full' === q ? void 0 : d[q],
            w = ('customer' === o || 'admin' === o) && !!l && 'hidden' !== r,
            x = h ?? a,
            y = !!c.trim(),
            z = !!l && ('customer' === o || 'admin' === o),
            A =
              t?.surfaceLabel ??
              (function (a) {
                switch (a) {
            ...
            B = t?.breadcrumbAriaLabel ?? 'Breadcrumb',
            C = t?.breadcrumbHomeLabel ?? 'Dashboard',
            D = t?.customerTopbarLabel ?? `${A} topbar`,
            E = t?.mobileNavigationLabel ?? 'Navigation',
            F = t?.mobileNavigationOpenLabel ?? 'Open',
            G = t?.collapseSidebarLabel ?? 'Collapse sidebar menu',
            H = t?.expandSidebarLabel ?? 'Expand sidebar menu',
            I = t?.brandMarkAlt ?? s ?? 'Elite Message logo';
          return (0, b.jsxs)('main', {
            ...
            style: {
              ...
              padding: 'hidden' === r || w ? 0 : 'clamp(18px, 2vw, 26px)',
              color: 'var(--elite-ink)',
            },
            children: [
              (0, b.jsx)('style', { children: f }),
              (0, b.jsxs)('div', {
                className: 'elite-shell-frame',
                'data-has-nav': l ? 'true' : 'false',
                children: [
                  w
                    ? (0, b.jsxs)('div', {
                          ...
                          (0, b.jsx)(g, {
                            ...
                            markSrc:
                              'customer' === o
                                ...
                                : void 0,
                            markAlt: I,
                            launcherControlsId: u,
                            launcherButtonLabel: G,
                            launcherExpandLabel: H,
                            onLauncherClick: z
                              ? (a) => {
                                  let b =
                  ...
                  (0, b.jsx)('div', {
                    ...
                    children: (0, b.jsxs)('div', {
                      ...
                      style: { maxWidth: v, margin: l ? void 0 : '0 auto' },
                      children: [
                        'hidden' === r
                          ? null
                          : (0, b.jsxs)('header', {
                              className: `elite-page-header${'customer' === o ? ' elite-page-header-customer' : ''}`,
                              children: [
                                w
                                  ? null
                                  : (0, b.jsxs)('div', {
    ...
    (a.s(
      [
        ...
        'EmptyState',
        0,
        function ({ title: a, description: c, action: d }) {
          return (0, b.jsxs)('div', {
            className: 'elite-empty-state',
            children: [
              (0, b.jsx)('h3', { children: a }),
              (0, b.jsx)('p', { children: c }),
              d
                ? (0, b.jsx)('div', { className: 'elite-toolbar', children: d })
                : null,
            ],
          });
        },
    ...
    var i = a.i(40032),
      j = a.i(88706);
    (a.s([], 30154), a.i(30154), a.i(13140), a.i(67600), a.i(52294));
    let k = 'elite-message.theme';
    function l(a) {
    ...
    (a.s(
      ...
      a.j(j, 97096));
    var m = a.i(97096);
    async function n({ children: a }) {
      var d;
      let e = await (0, c.cookies)(),
        f = 'dark' === (d = l(e.get(k)?.value)) || 'light' === d ? d : 'light',
        g = 'dark' === f ? 'dark' : 'light';
      return (0, b.jsx)('html', {
        lang: 'en',
        'data-elite-theme': g,
        'data-elite-theme-preference': f,
        children: (0, b.jsx)('body', {
          children: (0, b.jsx)(m.ThemePreferenceProvider, {
            initialPreference: f,
            children: a,
          }),
        }),
...
//# sourceMappingURL=_0a_nbbs._.js.map
