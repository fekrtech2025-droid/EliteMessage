(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, a, t) => {
    ...
    for (var i in l) Object.defineProperty(t, i, { enumerable: !0, get: l[i] });
    let r = e.r(44066)._(e.r(12892)),
      ...
      ((a = a ? encodeURIComponent(a).replace(/%3A/i, ':') + '@' : ''),
        e.host
          ...
          : t &&
            ((s = a + (~t.indexOf(':') ? `[${t}]` : t)),
            e.port && (s += ':' + e.port)),
        d && 'object' == typeof d && (d = String(r.urlQueryToSearchParams(d))));
      let m = e.search || (d && `?${d}`) || '';
      return (
        l && !l.endsWith(':') && (l += ':'),
        e.slashes || ((!l || n.test(l)) && !1 !== s)
          ? ((s = '//' + (s || '')), i && '/' !== i[0] && (i = '/' + i))
          : s || (s = ''),
        o && '#' !== o[0] && (o = '#' + o),
        m && '?' !== m[0] && (m = '?' + m),
  ...
  (e, a, t) => {
    ...
    let l = e.r(87683),
      i = e.r(13708);
    function r(e) {
      if (!(0, l.isAbsoluteUrl)(e)) return !0;
      try {
        let a = (0, l.getLocationOrigin)(),
          t = new URL(e, a);
        return t.origin === a && (0, i.hasBasePath)(t.pathname);
      } catch (e) {
        return !1;
      }
    }
  ...
  (e, a, t) => {
    ...
    function f(a) {
      ...
      let i,
        r,
        f,
        [v, y] = (0, o.useOptimistic)(p.IDLE_LINK_STATUS),
        w = (0, o.useRef)(null),
        {
          href: k,
          as: j,
      ...
      let R = o.default.useContext(s.AppRouterContext),
        U = !1 !== N,
        F =
          !1 !== N
            ? null === (l = N) || 'auto' === l
            ...
            : b.FetchStrategy.PPR,
        H = 'string' == typeof (t = j || k) ? t : (0, d.formatUrl)(t);
      if (B) {
        ...
        r = o.default.Children.only(i);
      }
      let W = B ? r && 'object' == typeof r && r.ref : _,
        V = o.default.useCallback(
          (e) => (
            null !== R &&
              (w.current = (0, p.mountLinkInstance)(e, H, R, F, U, y)),
            () => {
              (w.current &&
        ...
        D = {
          ref: (0, m.useMergedRef)(V, W),
          onClick(a) {
            (B || 'function' != typeof P || P(a),
              B &&
                r.props &&
              ...
              !R ||
                a.defaultPrevented ||
                (function (a, t, l, i, r, n, d) {
                  if ('u' > typeof window) {
                    let s,
                      { nodeName: m } = a.currentTarget;
                    if (
                      ('A' === m.toUpperCase() &&
                        (((s = a.currentTarget.getAttribute('target')) &&
                          '_self' !== s) ||
                          a.metaKey ||
                          a.ctrlKey ||
                          a.shiftKey ||
                      ...
                      return;
                    if (!(0, g.isLocalURL)(t)) {
                      i && (a.preventDefault(), location.replace(t));
                      return;
                    }
                    ...
                    let { dispatchNavigateAction: h } = e.r(59224);
          ...
          onMouseEnter(e) {
            (B || 'function' != typeof T || T(e),
              B &&
                r.props &&
                'function' == typeof r.props.onMouseEnter &&
                r.props.onMouseEnter(e),
              R && U && (0, p.onNavigationIntent)(e.currentTarget, !0 === I));
          },
          onTouchStart: function (e) {
            (B || 'function' != typeof O || O(e),
              B &&
                r.props &&
      ...
      return (
        (0, h.isAbsoluteUrl)(H)
          ? (D.href = H)
          : (B && !M && ('a' !== r.type || 'href' in r.props)) ||
            (D.href = (0, c.addBasePath)(H)),
        (f = B
          ? o.default.cloneElement(r, D)
          : (0, n.jsx)('a', { ...$, ...D, children: i })),
        (0, n.jsx)(x.Provider, { value: v, children: f })
      );
    }
    e.r(82094);
    let x = (0, o.createContext)(p.IDLE_LINK_STATUS),
      v = () => (0, o.useContext)(x);
    ('function' == typeof t.default ||
      ('object' == typeof t.default && null !== t.default)) &&
      void 0 === t.default.__esModule &&
...
`;
    ...
    (e.s(
      [
        ...
        function ({
          ...
          let v = m ? `elite-shell-nav-${u}` : void 0,
            y = 'full' === g ? void 0 : t[g],
            w = ('customer' === u || 'admin' === u) && !!m && 'hidden' !== b,
            k = n ?? e,
            j = !!r.trim(),
            z = !!m && ('customer' === u || 'admin' === u),
            N =
              x?.surfaceLabel ??
              (function (e) {
                switch (e) {
            ...
            M = x?.breadcrumbAriaLabel ?? 'Breadcrumb',
            S = x?.breadcrumbHomeLabel ?? 'Dashboard',
            A = x?.customerTopbarLabel ?? `${N} topbar`,
            C = x?.mobileNavigationLabel ?? 'Navigation',
            P = x?.mobileNavigationOpenLabel ?? 'Open',
            T = x?.collapseSidebarLabel ?? 'Collapse sidebar menu',
            O = x?.expandSidebarLabel ?? 'Expand sidebar menu',
            B = x?.brandMarkAlt ?? f ?? 'Elite Message logo';
          return (0, a.jsxs)('main', {
            ...
            style: {
              ...
              padding: 'hidden' === b || w ? 0 : 'clamp(18px, 2vw, 26px)',
              color: 'var(--elite-ink)',
            },
            children: [
                ...
                children: [
                    ...
                    ? (0, a.jsxs)('div', {
                        ...
                        children: [
                          (0, a.jsx)(i, {
                            ...
                            launcherButtonLabel: T,
                            launcherExpandLabel: O,
                            onLauncherClick: z
                              ? (e) => {
                                  let a =
                  ...
                  (0, a.jsx)('div', {
                    ...
                    children: (0, a.jsxs)('div', {
                      ...
                      style: { maxWidth: y, margin: m ? void 0 : '0 auto' },
                      children: [
                        'hidden' === b
                          ? null
                          : (0, a.jsxs)('header', {
                              className: `elite-page-header${'customer' === u ? ' elite-page-header-customer' : ''}`,
                              children: [
                                w
                                  ? null
                                  : (0, a.jsxs)('div', {
      ...
      e.i(25762));
    function r({ children: e, tone: t = 'neutral' }) {
      return (0, a.jsx)('span', {
    ...
    function s(e) {
      return e.startsWith('/users')
        ? 'users'
        : e.startsWith('/workspaces')
          ? 'workspaces'
          : e.startsWith('/messages')
            ? 'messages'
            : e.startsWith('/workers/')
              ? 'worker-detail'
              : e.startsWith('/workers')
                ? 'workers'
    ...
    function m(e, a) {
      return (
        e === a ||
        ('worker-detail' === a && 'workers' === e) ||
        ('instance' === a && 'dashboard' === e)
      );
    }
    function h({ kind: e }) {
      switch (e) {
        case 'dashboard':
          return (0, a.jsxs)('svg', {
            ...
            'aria-hidden': 'true',
            children: [
              (0, a.jsx)('path', { d: 'M3.6 9.35 10 4.15l6.4 5.2' }),
              (0, a.jsx)('path', {
        ...
        case 'messages':
          return (0, a.jsxs)('svg', {
            ...
            children: [
              ...
              (0, a.jsx)('path', { d: 'M6.3 8.1h7.4' }),
              (0, a.jsx)('path', { d: 'M6.3 10.2h4.8' }),
            ],
          });
        case 'workers':
          return (0, a.jsxs)('svg', {
            ...
            children: [
              ...
              (0, a.jsx)('path', { d: 'M10 6.3H11.9' }),
              (0, a.jsx)('path', { d: 'M6 8.4v3.2' }),
              (0, a.jsx)('path', { d: 'M8.1 13.7H11.9' }),
              (0, a.jsx)('path', { d: 'M14 8.4v5.3' }),
            ],
          });
        case 'support':
          return (0, a.jsxs)('svg', {
            ...
            'aria-hidden': 'true',
            children: [
              (0, a.jsx)('path', { d: 'M10 15.9a5.9 5.9 0 1 0-5.9-5.9' }),
              (0, a.jsx)('path', { d: 'M4.1 10.05v2.75' }),
              (0, a.jsx)('path', { d: 'M15.9 10.05v2.75' }),
              (0, a.jsx)('path', {
        ...
        case 'audit':
          return (0, a.jsxs)('svg', {
            ...
            children: [
              ...
              (0, a.jsx)('path', { d: 'M8 9.8 9.35 11.15 12.2 8.3' }),
            ],
          });
        case 'users':
          return (0, a.jsxs)('svg', {
            ...
            'aria-hidden': 'true',
            children: [
              (0, a.jsx)('circle', { cx: '7.1', cy: '7.2', r: '2.2' }),
              (0, a.jsx)('circle', { cx: '13.25', cy: '8', r: '1.7' }),
              (0, a.jsx)('path', {
    ...
    function c() {
      return (0, a.jsx)('svg', {
        ...
        fill: 'none',
        'aria-hidden': 'true',
        children: (0, a.jsx)('path', { d: 'm7.2 4.9 4.9 5.1-4.9 5.1' }),
      });
    }
    function u(e, t) {
      let l = d.filter((a) => a.section === e);
      return 0 === l.length
        ? null
        : (0, a.jsxs)('div', {
                          ...
                          (0, a.jsxs)('span', {
                            ...
                            children: [
                              (0, a.jsx)('span', {
                                ...
                                'aria-hidden': 'true',
                                children: (0, a.jsx)(h, { kind: e.icon }),
                              }),
                              (0, a.jsx)('span', {
    ...
    e.s(
      [
        'AdminNav',
        0,
        function ({ current: e, account: t }) {
          let l = t
            ? {
                label: 'Active operator',
                name: t.user.displayName,
                metaPrimary: t.user.role.replaceAll('_', ' '),
                metaSecondary: t.user.email,
              }
            : {
                label: 'Admin surface',
                ...
                children: (0, a.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, a.jsxs)('div', {
                      ...
                      children: [
                        (0, a.jsx)('span', { children: l.metaPrimary }),
                        (0, a.jsx)('span', { children: l.metaSecondary }),
                      ],
                    }),
                  ],
                }),
                ...
                children: t
                  ? (0, a.jsxs)(a.Fragment, {
                      children: [
                        (0, a.jsx)(r, {
                          tone: 'warning',
                          children: t.user.displayName,
                        }),
                        (0, a.jsxs)(r, {
                          tone: 'neutral',
                          children: [t.workspaces.length, ' workspaces'],
                        }),
                      ],
                    })
                  : (0, a.jsx)(r, {
    ...
    (e.s(['resolveAdminThemePreference', 0, b], 50189), e.i(86544));
    let f = 'elite-message.admin.access-token',
      x = 'https://api.levan-pms.com';
    function v() {
      return window.sessionStorage.getItem(f);
    }
    function y(e) {
      window.sessionStorage.setItem(f, e);
    }
    function w() {
    ...
    async function j(e) {
      ...
      if (!a.ok) return (w(), e?.(null), null);
      let t = await a.json();
      return (y(t.accessToken), e?.(t.accessToken), t.accessToken);
    }
    async function z(e, a, t) {
      let l = e ?? v();
      if ((l || (l = await j(t)), !l)) return null;
      let i = l,
        r = await k(() => a(i));
      if (!r) return null;
      if (401 === r.status) {
        if (!(l = await j(t))) return null;
        let e = l;
        if (!(r = await k(() => a(e)))) return null;
      }
      return r;
    }
    async function N(e) {
      let a = await k(() =>
        fetch(`${x}/api/v1/account/me`, {
      ...
      if (!a.ok) throw Error('Could not load the admin account.');
      let t = await a.json();
      return ((0, n.setGlobalThemePreference)(b(t.themePreference)), t);
    }
    function M({ syncAccount: e = !1 }) {
      async function t(a) {
        if (!e) return;
        let t = await z(null, (e) =>
          fetch(`${x}/api/v1/account/me/theme`, {
            method: 'PATCH',
            headers: {
            ...
            credentials: 'include',
            body: JSON.stringify({ themePreference: a }),
          }),
        );
        if (!t || !t.ok) return;
      }
      return (0, a.jsx)(n.ThemePreferenceMenuButton, {
        options: ['light', 'dark'],
        onPreferenceChange: e ? t : void 0,
      });
    }
    function S(e) {
      if (!(e instanceof HTMLElement)) return;
      let a = e.closest('details');
      a instanceof HTMLDetailsElement && (a.open = !1);
    }
    function A({ children: e }) {
      return (0, a.jsx)('span', { 'aria-hidden': 'true', children: e });
    }
    function C() {
      return (0, a.jsxs)('svg', {
        viewBox: '0 0 20 20',
        ...
        children: [
          ...
          (0, a.jsx)('path', { d: 'M8.2 9.8 9.45 11.05 12.1 8.4' }),
        ],
      });
    }
    function P() {
      return (0, a.jsxs)('svg', {
        ...
        'aria-hidden': 'true',
        children: [
          (0, a.jsx)('path', { d: 'M4.5 8V4.5H8' }),
          (0, a.jsx)('path', { d: 'M12 4.5H15.5V8' }),
          (0, a.jsx)('path', { d: 'M15.5 12V15.5H12' }),
          (0, a.jsx)('path', { d: 'M8 15.5H4.5V12' }),
        ],
      });
    }
    function T() {
      return (0, a.jsxs)('svg', {
        ...
        'aria-hidden': 'true',
        children: [
          (0, a.jsx)('circle', { cx: '8.5', cy: '8.5', r: '4.25' }),
          (0, a.jsx)('path', { d: 'M12 12L16.25 16.25' }),
        ],
      });
    }
    function O() {
    ...
    (e.s(
      ...
      e.s(['AdminThemeControl', 0, M], 47548),
      e.s(
        [
          'AdminTopbarControls',
          0,
          function ({ account: e }) {
            let t = (0, p.useRouter)(),
              l = s((0, p.usePathname)() ?? '/'),
              i = e?.user.displayName ?? 'Admin Operator',
              r = e?.user.role.replaceAll('_', ' ') ?? 'Admin console',
              n = (i || e?.user.email || 'A').trim().charAt(0).toUpperCase(),
              [o, h] = (0, g.useState)(!1);
            function c(e) {
              t.push(e);
            }
            ...
            async function b() {
              try {
                await fetch(`${x}/api/v1/auth/logout`, {
                  method: 'POST',
                  credentials: 'include',
                });
              } finally {
                  ...
                  (0, a.jsxs)('div', {
                    ...
                    children: [
                      (0, a.jsxs)('button', {
                        ...
                        'data-active': 'dashboard' === l ? 'true' : 'false',
                        onClick: () => {
                          c('/');
                        },
                        children: [
                      ...
                      (0, a.jsx)('button', {
                        ...
                        'data-active': 'messages' === l ? 'true' : 'false',
                        onClick: () => {
                          c('/messages');
                        },
                        children: (0, a.jsx)(A, {
                      ...
                      (0, a.jsx)('button', {
                        ...
                        'data-active': 'users' === l ? 'true' : 'false',
                        onClick: () => {
                          c('/users');
                        },
                        children: (0, a.jsx)(A, {
                      ...
                      (0, a.jsx)('button', {
                        ...
                        'data-active': 'workspaces' === l ? 'true' : 'false',
                        onClick: () => {
                          c('/workspaces');
                        },
                        children: (0, a.jsx)(A, {
                      ...
                      (0, a.jsx)('button', {
                        ...
                        'data-active': 'support' === l ? 'true' : 'false',
                        onClick: () => {
                          c('/support');
                        },
                        children: (0, a.jsx)(A, {
                      ...
                      (0, a.jsx)('button', {
                        ...
                        'data-active': 'audit' === l ? 'true' : 'false',
                        onClick: () => {
                          c('/audit');
                        },
                        children: (0, a.jsx)(A, {
